...
<div class="container" style="min-width:1080px; margin-top: 100px;">
	...
	<h1>은성문고 로그인</h1>
		...
		<%
			} else if(fail != null && "quit".equals(fail)){
		%>
			<div class="alert alert-danger">
				<strong>[로그인 실패]</strong> 은성문고의 회원이 아닙니다. 회원가입을 해주세요.
			</div>
		<%
			}
		%>
	...
	<div class="row">
		...
		<h3>회원 로그인</h3>
			<form id="login-form" class="well" method="post" action="login.jsp">
				...
				<div class="text-right">
					<a href="../admin/adminmain.jsp" class="btn btn-default">관리자</a>			
					<a href="registerview.jsp" class="btn btn-info">은성문고 회원가입</a>
